...
@Entity
public class GroupChatReportEntity {
    ...
    private GroupChatReportEntity.ReportStatus status = GroupChatReportEntity.ReportStatus.PENDING;


    public GroupChatReportEntity() {
    }

    public GroupChatReportEntity(Long id, String reason, String comment, LocalDateTime dateTime, UserMaster owner, UserMaster reporter, GroupChatMaster groupChatMaster, ReportStatus status) {
        this.id = id;
        this.reason = reason;
        ...
        this.groupChatMaster = groupChatMaster;
        this.status = status;
    }
    ...
    public GroupChatMaster getGroupChatMaster() {
        return groupChatMaster;
    }

    public void setGroupChatMaster(GroupChatMaster groupChatMaster) {
        this.groupChatMaster = groupChatMaster;
    }
